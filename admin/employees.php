                            ...
                            <div class="card-body">
                                ...
                                <div class="data-tables datatable-dark">
                                    ...
                                    <table id="dataTable3" class="table table-hover table-striped text-center">
                                        ...
                                        <a href="add-employee.php" class="btn btn-sm btn-info text-center">Add New Employee</a>
                                        </div>
                                    ...
                                    <?php 
                                    $sql = "SELECT EmpId,UserName,Department,Status,RegDate,id from  tblemployees";
                                    $query = $dbh -> prepare($sql);
                                    $query->execute();
