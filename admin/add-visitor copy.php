                    ...
                    <div class="col-lg-6 col-ml-12">
                        <div class="row">
                            ...
                            <div class="col-12 mt-5">
                                ...
                                <!-- // Check if the form has been submitted using GET Form has not been submitted, display
                                the form -- -->
                                            ...
                                            <div class="form-row align-items-center">
                                                ...
                                                <div class="form-group col-4">
                                                    ...
                                                    <input class="form-control" name="idNo"
                                                        value="<?php echo $_GET['id']; ?>" type="tel" readonly
                                                ...
                                                <div class="form-group col-6">
                                                    ...
                                                    <select class="custom-select" name="purpose" autocomplete="off">
                                                        <option value="">Choose..</option>
