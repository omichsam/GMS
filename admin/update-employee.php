...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $sql = "UPDATE tblemployees set UserName=:userName,Gender=:gender,Department=:department,Phonenumber=:mobileno where id=:eid";
                                    ...
                                    <div class="card">
                                        <form name="addemp" method="POST">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <button class="btn btn-primary" name="update" id="update" type="submit">MAKE
                                                    CHANGES</button>
