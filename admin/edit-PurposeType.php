<?php
    ...
    $sql="UPDATE tblPurpose set Purpose=:Purpose,Description=:description,Department=:department where id=:lid";
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Purpose Section</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="Purpose-section.php">Purpose</a></li>
                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                 ...
                                 <div class="card-body">
                                        ...
                                        <p class="text-muted font-14 mb-4">Please make changes on the form below in order to update Purpose type</p>

                                        <?php
                                            $lid=intval($_GET['lid']);
                                            $sql = "SELECT * from tblPurpose where id=:lid";
                                            $query = $dbh -> prepare($sql);
                                            $query->bindParam(':lid',$lid,PDO::PARAM_STR);
                                            $query->execute();
                                    ...
                                    <div class="row align-items-center">
                                        <div class="form-group col-4">
                                            <label for="example-text-input" class="col-form-label">Purpose Type</label>
                                            <input class="form-control" name="Purpose" type="text" required id="example-text-input" value="<?php echo htmlentities($result->Purpose);?>" required>
                                        </div>
                                        ...
                                        <div class="form-group col-4">
                                                        ...
                                                        <select class="custom-select" name="department" autocomplete="off">
                                                            <option value="<?php echo htmlentities($result->Purpose);?>"> <?php echo htmlentities($result->Purpose);?></option>
