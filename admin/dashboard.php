    ...
    <body>
        ...
        <div class="page-container">
            ...
            <div class="main-content">
                ...
                <!-- page title area end -->
                <div class="main-content-inner z-2">
                    <!--  report area start -->
                    <div class="sales-report-area mt-5 mb-5 z-2">
                        <div class="row">
                            <div class="col-md-4 cards">
                                <div class="single-report mb-xs-30 cards cards border border-secondary">
                                    <div class="s-report-inner pr--20 pt--30 mb-3">
                                        <div class="icon"><i class="fa fa-briefcase"></i></div>
                                        <div class="s-report-title d-flex justify-content-between">
                                            <h4 class="header-title mb-0">Total Visitors</h4>

                                        </div>
                                        <div class="d-flex justify-content-between pb-2">
                                            <h1>
                                                <?php include 'counters\totalVisitors.php' ?>
                                            </h1>
                                            <span>Visitors</span>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4 cards">
                                <div class="single-report cards cards border border-secondary">
                                    <div class="s-report-inner pr--20 pt--30 mb-3">
                                        <div class="icon"><i class="fa fa-arrow-down  fa-beat-fade"></i></div>
                                        <div class="s-report-title d-flex justify-content-between">
                                            <h4 class="header-title mb-0">Checked-in(TODAY)</h4>

                                        </div>
                                        <div class="d-flex justify-content-between pb-2">
                                            <h1>
                                                <?php include 'counters/checkIn.php' ?>
                                            </h1>
                                            <span>Visitors</span>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4 cards">
                                <div class="single-report mb-xs-30 cards cards border border-secondary">
                                    <div class="s-report-inner pr--20 pt--30 mb-3">
                                        <div class="icon"><i class="fa-solid fa fa-arrow-up  fa-beat-fade"></i></div>
                                        <div class="s-report-title d-flex justify-content-between">
                                            <h4 class="header-title mb-0">Checked-out(TODAY)</h4>

                                        </div>
                                        <div class="d-flex justify-content-between pb-2">
                                            <h1>
                                                <?php include 'counters/checkOut.php' ?>
                                            </h1>
                                            <span>Visitors</span>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4 cards">
                                <div class="single-report cards cards border border-secondary">
                                    <div class="s-report-inner pr--20 pt--30 mb-3">
                                        ...
                                        <div class="d-flex justify-content-between pb-2">
                                            <h1>
                                                <?php include 'counters/dept-counter.php' ?>
                                            </h1>
                            ...
                            <div class="col-md-4 cards">
                                <div class="single-report mb-xs-30 cards cards border border-secondary">
                                    <div class="s-report-inner pr--20 pt--30 mb-3">
                                        ...
                                        <div class="s-report-title d-flex justify-content-between">
                                            <h4 class="header-title mb-0">Total Offices</h4>

                                        </div>
                                        <div class="d-flex justify-content-between pb-2">
                                            <h1>
                                                <?php include 'counters/office-counter.php' ?>
                                            </h1>
                                            <span>Offices</span>
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-4 cards ">
                                <div class="single-report mb-xs-30 cards cards border border-secondary">
                                    <div class="s-report-inner pr--20 pt--30 mb-3">
                                        ...
                                        <div class="d-flex justify-content-between pb-2">
                                            <h1>
                                                <?php include 'counters/emp-counter.php' ?>
                                            </h1>
