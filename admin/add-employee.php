...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['add'])) {
        ...
        $sql = "INSERT INTO tblemployees(EmpId,UserName,EmailId,Password,Gender,Department,Phonenumber,Status) 
        VALUES(:empid,:userName,:email,:password,:gender,:department,:mobileno,:status)";
                                                ...
                                                <div class="form-row align-items-center">
                                                    <div class="form-group col-4">
                                                        ...
                                                        <input class="form-control" name="empcode" type="text"
                                                            autocomplete="off" required id="empcode"
                                                            onBlur="checkAvailabilityEmpid()">
                                                    </div>
                                                ...
                                                <div class="form-row align-items-center">
                                                    <div class="form-group col-4">
                                                        ...
                                                        <input class="form-control" name="password" type="password"
                                                            autocomplete="off" value="1234" required>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-4">
                                                        ...
                                                        <input class="form-control" name="confirmpassword" type="password"
                                                            autocomplete="off" value="12345" required>
                                                    </div>
                                                </div>
