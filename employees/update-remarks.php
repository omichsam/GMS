...
if (strlen($_SESSION['alogin']) == 1) {
    ...
    if (isset($_POST['update'])) {
        ...
        $sql = "UPDATE tblleaves set AdminRemark=:description,Status=:status,
        AdminRemarkDate=:admremarkdate where id=:did";
        $query = $dbh->prepare($sql);
                    ...
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <div class="breadcrumbs-area clearfix">
                                <h4 class="page-title pull-left">Update Remarks Details</h4>
                                <ul class="breadcrumbs pull-left">
                                    <li><a href="dashboard.php">Home</a></li>
                                    <li><span>Visits Details</span></li>
                                </ul>
                            </div>
                        </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-hover text-center">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php
                                                    $lid = intval($_GET['id']);
                                                    $sql = "SELECT * FROM `tblvisitorlog` WHERE `id`=:lid";
                                                    $query = $dbh->prepare($sql);
                                                    ...
                                                    if ($query->rowCount() > 0) {
                                                        foreach ($results as $result) {
                                                            ...
                                                            <tr>
                                                                <td><b>CheckingInTime:</b></td>
                                                                <td colspan="1">
                                                                    <?php echo htmlentities($result->CheckingInTime); ?>
                                                                </td>
                                                                <td><b>CheckingOutTime:</b></td>
                                                                <td colspan="1">
                                                                    <i class="fa-2x fa fa-spinner fa-pulse"></i>
                                                                    <!-- < ?php echo htmlentities($result->CheckingOutTime); ?> -->
                                                                </td>
                                                            </tr>

                                                            <tr>
                                                                <!-- SELECT `id`, `VisitorID`, `StaffID`, `CheckingInTime`,
                                                                `CheckingOutTime`, `Purpose`, `remark`, `department`, `office`,
                                                                `FullName`, `status` FROM `tblvisitorlog` WHERE 1 -->
                                                                ...
                                                                <td><b>Office:</b></td>
                                                                <td colspan="1">
                                                                    <?php echo htmlentities($result->office); ?>
                                                                </td>
                                                                ...
                                                                <tr>
                                                                    <td colspan="12">
                                                                        <button type="button" class="btn btn-success"
                                                                            data-toggle="modal" data-target="#exampleModal"> APPROVE
                                                                            VISIT</button>
                                                                                    ...
                                                                                    <form method="POST" name="adminaction">
                                                                                        <div class="modal-body">
                                                                                            ...
                                                                                            <p><textarea id="textarea1"
                                                                                                    ...
                                                                                                    placeholder="Add remarks about visit"
                                                                                                    row="5" maxlength="500"
                                                                                                    required></textarea>
                                                                                            </p>
                                                                                        </div>
