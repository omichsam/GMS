...
if (strlen($_SESSION['emplogin']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $sql = "update tblemployees set UserName=:UserName,cardNo=:cardNo,Gender=:gender,Department=:department,Phonenumber=:mobileno where EmailId=:eid";
                        ...
                        <div class="col-lg-6 col-ml-12">
                            <div class="row">
                                ...
                                <div class="col-12 mt-5">
                                    ...
                                    <?php } ?>
                                    <div class="card">
                                        <form name="addemp" method="GET">

                                            <div class="card-body">
                                                <h4 class="header-title">Update My Profile</h4>
                                                <p class="text-muted font-14 mb-4">Please make changes on the form below in
                                                    order to update your profile</p>
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-4">
                                                                ...
                                                                <input class="form-control" name="UserName"
                                                                    ...
                                                                    type="text" required id="example-text-input">
                                                            </div>
                                                            ...
                                                            <div class="form-group col-4">
                                                                <label for="example-text-input" class="col-form-label">Employee
                                                                    ID</label>
                                                                <input class="form-control" name="empcode" type="text"
                                                            ...
                                                            <div class="form-group col-4">
                                                                <label for="example-text-input"
                                                                    class="col-form-label">cardNo</label>
                                                                <input class="form-control" name="cardNo" type="text"
                                                                    value="<?php echo htmlentities($result->cardNo); ?>"
                                                                    autocomplete="off" required id="example-text-input">
                                                            </div>
                                                ...
                                                <button class="btn btn-success" name="update" id="update" type="submit">MAKE
                                                    CHANGES</button>
